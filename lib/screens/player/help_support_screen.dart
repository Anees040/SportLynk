      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _faqItem('How do security deposits work?', 
              'When you book a venue, the security deposit is temporarily frozen in your wallet. It is released to the venue owner when you check in or if you fail to show up.'),
            _faqItem('What happens if I cancel a booking?', 
              'If you cancel more than 12 hours before the start time, your security deposit is fully refunded. If you cancel later, the deposit is forfeited to the venue owner.'),
